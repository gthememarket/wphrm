...
<script src="https://cdnjs.cloudflare.com/ajax/libs/rateYo/2.2.0/jquery.rateyo.min.js"></script>
  ...
  <table class="table table-striped table-resposive" style="width:90%; margin-bottom: 100px;">
    <thead>
      <tr>
	...
	if(!empty($leavedata)){		
		...
		?>
		 <tr>
			...
			<td><?php print $retrive_data->start_date; ?></td>
			<td><?php print $retrive_data->end_date; ?></td>
	...
	<tbody>
		...
		foreach($performancedata as $key=>$retrive_data){ ?>
			<tr>
				...
				<td><?php print $retrive_data->period_start ?></td>
	...
	<tbody>
		...
		foreach($obj_project as $key=>$retrive_data){ ?>
			<tr>
				...
				<td><?php print $retrive_data->start_date ?></td>
				<td><?php print $retrive_data->end_date	 ?></td>
				<td><?php print $retrive_data->completion_date?></td>
