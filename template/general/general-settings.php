...
$(document).ready(function() {
	...
	<div class="panel-body">
		<h2><?php  echo esc_html( __( 'General Settings', 'hr_mgt')); ?></h2>		
		<div class="panel-body">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input id="hrmgt_company_address" class="form-control validate[required]" type="text" value="<?php echo get_option( 'hrmgt_office_address' );?>"  name="hrmgt_company_address">
			</div>
		</div>
		<div class="form-group">
