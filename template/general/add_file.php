...
$(document).ready(function() {
	...
	$('#added_date').datepicker({
     ...
     <?php 	                                 
        ...
        <form name="file_form" action="" method="post" class="form-horizontal" enctype="multipart/form-data" id="file_form">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">                   
                <select name="doc_for[]" multiple="multiple" class="form-control" id="doc_for" required>                    	
