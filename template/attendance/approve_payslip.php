...
<div class="col-md-6">
	<table class="table table-bordered">
		<tr style="background:#D99594;" > 
			<th colspan="3" style="text-align:center; text-transform:uppercase"><?php _e('Earnings','hr_mgt'); ?></th>
		</tr>
...
<div class="col-md-6">
	<table class="table table-bordered">
		<tr style="background:#FABF8F" >
			<th colspan="2" style="text-align:center; text-transform:uppercase"><?php _e('Deduction','hr_mgt'); ?></th>
		</tr>
