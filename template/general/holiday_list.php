    ...
    <div class="table-responsive">
		...
		$attendancedata=$obj_holiday->get_all_holidays($year);			
		 if(!empty($attendancedata))
		 {
            ...
            <tr>
				<?php if($role=="manager"){ ?>
					<td class="Employee"><a href="?hr-dashboard=user&page=genral&tab=add_holiday&action=edit&holiday_id=<?php echo $retrieved_data->id;?>"><?php echo $retrieved_data->holiday_title;?></a></td>
				<?php }else { ?> 
					<td class="Employee"><?php echo $retrieved_data->holiday_title;?></td>
				<?php } ?>
				...
				<td class="action">	
					...
					<?php if($role=="manager"){ ?> 
						<a href="?hr-dashboard=user&page=genral&tab=add_holiday&action=edit&holiday_id=<?php echo $retrieved_data->id ?>" class="btn btn-info"> <?php _e('Edit', 'hr_mgt' ) ;?></a>
					<a href="?hr-dashboard=user&page=genral&tab=holiday_list&action=delete&holiday_id=<?php echo $retrieved_data->id;?>" class="btn btn-danger" 
