 ...
 $('#joining_date').datepicker({
	...
	?>		
       <div class="panel-body" style="float:left; width:100%">
		...
		<div class="form-group">
			<label class="col-sm-2 control-label" for="employee_salary"><?php _e('HR Manager Salary','hr_mgt');?><span class="require-field">*</span></label>
			<div class="col-sm-8">
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				...
				value="<?php if($edit)echo esc_url( $user_info->hrmgt_user_avatar );elseif(isset($_POST['hidden_upload_user_avatar_image'])) echo $_POST['hidden_upload_user_avatar_image']; ?>" />
			</div>	
			<div class="col-sm-3">
		...
		<div class="col-sm-offset-2 col-sm-8">
        	<input type="submit" value="<?php if($edit){ _e('Save','hr_mgt'); }else{ _e('Add HR Manager','hr_mgt');}?>" name="save_staff" class="btn btn-success"/>
        </div>		
        </form>
        </div>
