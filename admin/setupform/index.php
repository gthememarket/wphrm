...
<?php 
$active_tab = isset($_GET['tab'])?$_GET['tab']:'hrmgt-setup';
?>
<div id="cmgt_imgSpinner1"></div>
<div class="cmgt_ajax-ani"></div>
<div class="cmgt_ajax-img"><img src="<?php echo HRMS_PLUGIN_URL.'/assets/images/loading.gif';?>" height="50px" width="50px"></div>
