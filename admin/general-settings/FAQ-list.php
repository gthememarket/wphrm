    ...
    <form name="activity_form" action="" method="post">
		...
		<tbody>
		 ...
		 if(!empty($faqdata))
		 {
            ...
            <tr>
				<td class="title"><a href="?page=hrmgt-general_settings&tab=add_FAQ&action=edit&FAQ_id=<?php echo $retrieved_data->id;?>"><?php echo $retrieved_data->title;?></a></td>
				...
				<a href="?page=hrmgt-general_settings&tab=add_FAQ&action=edit&FAQ_id=<?php echo $retrieved_data->id?>" class="btn btn-info"> <?php _e('Edit', 'hr_mgt' ) ;?></a>
				<a href="?page=hrmgt-general_settings&tab=FAQ_list&action=delete&FAQ_id=<?php echo $retrieved_data->id;?>" class="btn btn-danger" 
