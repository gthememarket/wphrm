...
<div class="row">
			...
			{ ?>				
				<div class="cal_sel">
					...
					?>
						...
						<?php  $print_d = date("d",strtotime($date));	?>	
						<b><?php 
							...
							{								
								...
								CASE "manual_P" :						
									echo "<a href='#' class='$class x_{$day}' status='P' day='$day' id='x_$day' detail_id='$record->id' data='$user_id/$day/$month/$year' date='{$day}/{$month}/{$year}'> <div style='background:#5CB85C'>$manual_before P $manual_after</div></a>";
									break;
	...
	<div class="col-md-4">		
		<table class="table-bordered table">
			...
			<tr>
				<th class="label-success text-center" style='color:#fff; font-weight: bold;'><?php _e('P','hr_mgt')?></th>
				<th class="label-danger text-center" style='color:#fff; font-weight: bold;'><?php _e('A','hr_mgt')?></th>
				<th class="label-primary text-center" style='color:#fff; font-weight: bold;' ><?php _e('H','hr_mgt')?></th>
				<th class="label-success text-center" style='color:#fff; font-weight: bold;' ><?php _e('HL','hr_mgt')?></th>
				<th class="label-warning text-center" style='color:#fff; font-weight: bold;' ><?php _e('AA','hr_mgt')?></th>
		...
		<table class="table-bordered table">
			<tr>
				...
				<th style="text-align: center;font-weight: bold;"><?php _e('Pay. Days','hr_mgt');?></th>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="center"><?php print $obj_PlManagement->hrmgt_get_emp_pl($record->employee_id,$month,$year);?></td>
...
<table class='table table-bordered'>
	...
	<th rowspan="2" class='text-center' style='border:1px solid !important'><?php _e('Pay. Days','hr_mgt')?></th>
	<tr>
	...
	<tbody>			
		...
		?>	
			...
			<td align="center"><?php echo $obj_HrmgtAttendanceDetails->get_monthly_working_hour($record->employee_id,$record->month,$record->year).'/'. $obj_HrmgtAttendanceDetails->get_outof_working_hour($record->employee_id,$record->month,$record->year); ?></td>
			<td align="center"><?php echo $record->opening_pl ; ?></td>
			<td align="center"><?php print $obj_PlManagement->hrmgt_get_emp_pl($record->employee_id,$month,$year); ?></td>			<td align="center"><?php echo $record->used_pl ; ?></td>
			<td align="center"><?php echo $record->remaining_pl ; ?></td>
