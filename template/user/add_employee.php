	...
	<input type="hidden" name="role" value="<?php echo $role;?>"  />
		...
		<div class="form-group">
			...
			<?php
				if($edit == 0)
				{
					$employee_code = $obj_user->generate_employee_code();					
				}				
			?>
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input id="birth_date" class="form-control validate[required] date" type="text"  name="birth_date" 
		...
		<div class="form-group">
			<label class="col-sm-2 control-label" for="Perfomance_Incentives"><?php _e('Performance Incentives','hr_mgt');?></label>
			<div class="col-sm-6">
		...
		{ 	$e=9;
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input id="<?php print $value ?>" class="form-control text-input" type="text" value="<?php  if(isset($EarningData) && isset($edit)) print $EarningData["$e"]->amount ?>" name="<?php print $value ?>">
				</div>				
			</div>		
			<?php $e++; } 
		}
		...
		{ 	$d=4;
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input id="<?php print $deduction_value ?>" class="form-control text-input" type="text" value="<?php if(isset($EarningData) && isset($edit)) print $DeductionData["$d"]->amount ?>" name="<?php print $deduction_value ?>">
				</div>				
			</div>		
			<?php $d++; } 
		}
		...
		<div class="form-group">
			...
			<div class="col-sm-2">
				...
				value="<?php if($edit)echo esc_url( $result->hrmgt_user_avatar );elseif(isset($_POST['hidden_upload_user_avatar_image'])) echo $_POST['hidden_upload_user_avatar_image']; ?>" />
			</div>	
			<div class="col-sm-3">
