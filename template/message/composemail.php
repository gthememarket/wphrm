...
if(isset($result))
{ ?>
	<div id="message" class="updated below-h2 msg "><p>	<?php _e('Message Sent Successfully!','hr_mgt'); ?></p></div>	
<?php }	?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <select name="receiver" class="form-control validate[required] text-input" id="to">
				<option value="employee"><?php _e('All Employee','apartment_mgt');?></option>
